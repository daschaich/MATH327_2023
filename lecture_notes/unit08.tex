...
\renewcommand{\moddate}{Last modified 24 Apr.~2023}
...
\begin{center}\includegraphics[width=0.65\textwidth]{figs/unit08_wavelengths.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
...
\begin{mdframed}
  $\displaystyle \frac{\vev{E}_{\text{ph}}}{V} = \frac{1}{c^3 \pi^2} \int_0^{\infty} \om^2 \pderiv{}{\be} \log\left[1 - e^{-\be \hbar \om}\right] \mathop{d\om} = $ \\[120 pt] % WARNING: FORMATTING BY HAND
\end{mdframed}
...
\begin{mdframed}
  $\displaystyle \frac{\vev{E}_{\text{ph}}}{V} = \frac{\hbar}{c^3 \pi^2} \int_0^{\infty} \frac{\om^3}{e^{\be \hbar \om} - 1} \mathop{d\om} = $ \\[120 pt] % WARNING: FORMATTING BY HAND
\end{mdframed}
...
\begin{center}\includegraphics[width=0.95\textwidth]{figs/unit08_sun.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
...
\begin{center}\includegraphics[width=0.7\textwidth]{figs/unit08_pressure.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
% ------------------------------------------------------------------
...
In the case of metals, the density of conducting electrons (fermions not bound to particular atoms) is similar, leading to Fermi energies $E_F \sim 10^4$~K, very large compared to everyday temperatures. % 2--10 eV with eV~1.16e4 K being the Boltzmann constant
...
\end{equation*}
Even for a young white dwarf that retains its initial core temperature of roughly ten million kelvin, we have $T \sim 10^7~\mbox{K} \ll E_F$ and can accurately describe the star using the low-temperature ideal (non-interacting) fermion gas we analyzed above. % 0.3 MeV ~ 10^5 eV with eV~1.16e4 K being the Boltzmann constant
...
In isolation, white dwarfs will happily cool for trillions of years, supported by their degeneracy pressure, until they reach thermal equilibrium with the $\sim$$2.725$~K cosmic microwave background radiation we discussed in \secref{sec:planck}.
...
\begin{center}\includegraphics[width=0.7\textwidth]{figs/unit08_nova.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO START NEXT SECTION ON THIS PAGE
...
In fact, by changing units we can see that the white dwarf Fermi energy discussed above, $E_F \sim 10^9~\text{K} \sim 0.3$~MeV is comparable to the $0.511$~MeV rest-energy of electrons, suggesting that relativistic effects may be non-negligible in white dwarfs. % eV~1.16^4 K is the Boltzmann constant
...
Due to these negative signs, when we compute derived quantities like $\vev{E}_{\nu} = \pderiv{}{\be} \left[\be \Phi_{\nu}\right]$ and $\vev{N}_{\nu} = -\left. \pderiv{}{\mu} \Phi_{\nu}\right|_{\mu = 0}$ by taking derivatives of the potential, we will encounter slightly different but equally enjoyable integrals: % Fermi--Dirac integral involving polylog of -1 related to Dirichlet eta function...
\begin{align*}
...
\begin{center}\noindent\includegraphics[width=0.5\textwidth]{figs/unit08_Sommerfeld.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
...
\begin{mdframed}
  ...
  $\displaystyle \Ibb_2 = \int_{-\infty}^{\infty} \frac{x^2 e^x}{\left(e^x + 1\right)^2} \dx = $ \\[110 pt] % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
\end{mdframed}
