...
\begin{center}\includegraphics[width=0.9\textwidth]{figs/unit08_sun.pdf}\end{center} % WARNING: ADJUSTED SIZE BY HAND TO FILL REMAINDER OF PAGE
...
The plot below (produced by \href{https://github.com/daschaich/MATH327_2023/blob/master/lecture_notes/figs/unit08_pressure.py}{this Python code}) shows how the pressure changes from a positive constant as $T \to 0$ to this linear behaviour at higher temperatures. \\[-24 pt]
...
Fortunately, it is not hard to numerically evaluate this integral, which is done by \href{https://github.com/daschaich/MATH327_2023/blob/master/lecture_notes/unit08_fermi-gas.py}{this Python code}.
