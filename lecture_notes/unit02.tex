...
\renewcommand{\moddate}{Last modified 19 Feb.~2023}
...
\begin{itemize} % Adapted from a tutorial activity since sufficiently important to include in the main material...
...
In so-called \textbf{natural} systems, larger energies make more micro-states accessible, producing $\pderiv{M}{E} > 0$ and a positive temperature. % TODO: Remove `so-called'...
